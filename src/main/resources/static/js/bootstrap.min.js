...
!function (t, e) {
    ...
    let k = 1;
    const L = {mouseenter: "mouseover", mouseleave: "mouseout"}, S = /^(mouseenter|mouseleave)/i,
    ...
    const K = {
        ...
        }, getDataAttribute: (t, e) => $(t.getAttribute("data-bs-" + U(e))), offset(t) {
        ...
        wrap: "boolean",
        touch: "boolean"
    }, Q = "next", G = "prev", Z = "left", J = "right", tt = {ArrowLeft: J, ArrowRight: Z};
    ...
    class et extends R {
        ...
        _slide(t, e) {
            const i = this._directionToOrder(t), s = V.findOne(".active.carousel-item", this._element),
                n = this._getItemIndex(s), o = e || this._getItemByOrder(i, s), r = this._getItemIndex(o),
                a = Boolean(this._interval), l = i === Q, c = l ? "carousel-item-start" : "carousel-item-end",
    ...
    const it = {toggle: !0, parent: null}, st = {toggle: "boolean", parent: "(null|element)"};
    ...
    const vt = {trapElement: null, autofocus: !0}, wt = {trapElement: "element", autofocus: "boolean"};
    ...
    const Pt = new Set(["sanitize", "allowList", "sanitizeFn"]), xt = {
            animation: "boolean",
            template: "string",
    ...
    class Bt extends R {
        ...
        show() {
            ...
            const t = H.trigger(this._element, this.constructor.Event.SHOW), e = u(this._element),
    ...
    class Kt extends R {
        ...
        _getConfig(t) {
            return (t = {...Wt, ...K.getDataAttributes(this._element), ..."object" == typeof t && t ? t : {}}).target = l(t.target) || document.documentElement, c("scrollspy", t, $t), t
        }
    ...
    class Vt extends R {
        ...
        _activate(t, e, i) {
            const s = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? V.children(e, ".active") : V.find(":scope > li > .active", e))[0],
                n = i && s && s.classList.contains("fade"), o = () => this._transitionComplete(t, s, i);
